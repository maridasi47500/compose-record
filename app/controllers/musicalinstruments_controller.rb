class MusicalinstrumentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @musicalinstrument.update(musicalinstrument_params)
        format.html { redirect_to @musicalinstrument, notice: "Musicalinstrument was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to musicalinstruments_path, notice: "Musicalinstrument was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def musicalinstrument_params
      params.require(:musicalinstrument).permit(:name)
    end
end
