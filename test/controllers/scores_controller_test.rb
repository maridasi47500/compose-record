...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference("Score.count") do
      post scores_url, params: { score: { content: @score.content, key: @score.key, time: @score.time, title: @score.title } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { content: @score.content, key: @score.key, time: @score.time, title: @score.title } }
